...
const translations = {
  en: {
    ...
    'nav.contact': '/contact',
    'nav.cta': "Let's talk →",
    'hero.role': 'Full Stack Developer · UI Designer · Builder',
    'hero.blurb': '3+ years converting ideas into real digital products — spanning frontend, backend, and everything in between.',
    'hero.cv': 'Download CV ↓',
    'hero.viewWork': '/view work',
    'stats.years': 'Years of experience',
    'stats.projects': 'Projects delivered',
    'stats.technologies': 'Technologies',
    'stats.desc1': 'In full stack web development — spanning freelance, internship, and client projects across various industries.',
    'stats.desc2': 'From landing pages to complex web applications — shipped with clean code and attention to every detail.',
    ...
    'cta.nextChapter': 'From idea to reality.',
    'cta.chapter': 'chapter.',
  ...
  id: {
    ...
    'nav.contact': '/kontak',
    'nav.cta': 'Mari bicara →',
    'hero.role': 'Full Stack Developer · UI Designer · Pembuat',
    ...
    'stats.desc1': 'Dalam pengembangan web full stack — mencakup freelance, magang, dan proyek klien di berbagai industri.',
    'stats.desc2': 'Dari landing page hingga aplikasi web kompleks — dikirimkan dengan kode bersih dan perhatian pada setiap detail.',
    ...
    'marquee.db': 'Arsitektur Database',
    'marquee.react': 'React & Next.js',
    'marquee.laravel': 'Laravel & Node.js',
    ...
    'experience.lede': '3+ tahun membangun aplikasi web melalui freelance, magang, dan pekerjaan penuh waktu.',
